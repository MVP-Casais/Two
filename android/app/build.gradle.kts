...
android {
    ...
    defaultConfig {
        ...
        // Você pode atualizar os valores abaixo para atender às necessidades do seu aplicativo.
        // Para mais informações, veja: https://flutter.dev/to/review-gradle-config.
